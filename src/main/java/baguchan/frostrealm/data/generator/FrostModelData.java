...
public class FrostModelData extends ModelProvider {
    private final PackOutput.PathProvider blockStatePathProvider;
    private final PackOutput.PathProvider itemInfoPathProvider;
    private final PackOutput.PathProvider modelPathProvider;

    public FrostModelData(PackOutput packOutput) {
        super(packOutput, FrostRealm.MODID);
    ...
    public CompletableFuture<?> run(CachedOutput output) {
        ...
        this.registerModels(new FrostBlockModels(blockModelOutput, itemModelOutput, modelOutput), new FrostItemModels(itemModelOutput, modelOutput));
