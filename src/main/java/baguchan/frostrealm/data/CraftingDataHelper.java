...
public abstract class CraftingDataHelper extends RecipeProvider {
    ...
    public void makeStairs(RecipeOutput consumer, Block stairsOut, Block blockIn) {
		ShapedRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.BUILDING_BLOCKS, stairsOut, 4)
				.pattern("M  ")
				.pattern("MM ")
				.pattern("MMM")
				.define('M', blockIn)
    ...
    public void makeWoodFence(RecipeOutput consumer, Block fenceOut, Block blockIn) {
		ShapedRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.BUILDING_BLOCKS, fenceOut, 3)
				.pattern("MSM")
				.pattern("MSM")
				.define('M', blockIn)
    ...
    public void makeFenceGate(RecipeOutput consumer, Block fenceOut, Block blockIn) {
		ShapedRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.BUILDING_BLOCKS, fenceOut)
				.pattern("SMS")
				.pattern("SMS")
				.define('M', blockIn)
				.define('S', Tags.Items.RODS_WOODEN)
    ...
    public void makeDoor(RecipeOutput consumer, Block doorOut, Block blockIn) {
		ShapedRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.BUILDING_BLOCKS, doorOut, 3)
				.pattern("DD")
				.pattern("DD")
				.pattern("DD")
				.define('D', blockIn)
    ...
    public void makeFrostTorch(RecipeOutput consumer, Item torchOut) {
		ShapedRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.BUILDING_BLOCKS, torchOut, 4)
                .pattern("C")
                .pattern("M")
	...
	protected final ResourceKey<Recipe<?>> locEquip(String name) {
		return ResourceKey.create(Registries.RECIPE, FrostRealm.prefix("equipment/" + name));
    }
}