...
public class CrystalSmithingRecipeBuilder {
	...
	public CrystalSmithingRecipeBuilder(RecipeSerializer<?> p_248989_, Ingredient p_250309_, Ingredient p_249517_, RecipeCategory p_248993_, Item p_252083_) {
		this.category = p_248993_;
		this.type = p_248989_;
		this.base = p_250309_;
		this.addition = p_249517_;
		this.result = p_252083_;
	}

	public static CrystalSmithingRecipeBuilder smithing(Ingredient p_249698_, Ingredient p_249725_, RecipeCategory p_248633_, Item p_249938_) {
		return new CrystalSmithingRecipeBuilder(FrostRecipes.RECIPE_CRYSTAL_SMITHING.get(), p_249698_, p_249725_, p_248633_, p_249938_);
	}
	...
	public void save(Consumer<FinishedRecipe> p_126396_, ResourceLocation p_126397_) {
		...
		p_126396_.accept(new CrystalSmithingRecipeBuilder.Result(p_126397_, this.type, this.base, this.addition, this.result, this.advancement, p_126397_.withPrefix("recipes/" + this.category.getFolderName() + "/")));
	}
