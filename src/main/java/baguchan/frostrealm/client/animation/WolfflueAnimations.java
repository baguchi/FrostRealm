...
public class WolfflueAnimations {
    ...
    public static final AnimationDefinition baby = AnimationDefinition.Builder.withLength(0.0F)
            ...
            .addAnimation("rightLeg2", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(2.0F, -5.0F, 2.0F), AnimationChannel.Interpolations.LINEAR)
            ))
            .addAnimation("rightLeg2", new AnimationChannel(AnimationChannel.Targets.SCALE,
                    new Keyframe(0.0F, KeyframeAnimations.scaleVec(0.6F, 0.6F, 0.6F), AnimationChannel.Interpolations.LINEAR)
            ))
            .addAnimation("rightLeg3", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(2.0F, -5.0F, -5.0F), AnimationChannel.Interpolations.LINEAR)
            ))
            .addAnimation("rightLeg3", new AnimationChannel(AnimationChannel.Targets.SCALE,
                    new Keyframe(0.0F, KeyframeAnimations.scaleVec(0.6F, 0.6F, 0.6F), AnimationChannel.Interpolations.LINEAR)
            ))
            .addAnimation("leftLeg2", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(-2.0F, -5.0F, 2.0F), AnimationChannel.Interpolations.LINEAR)
            ...
            .addAnimation("leftLeg3", new AnimationChannel(AnimationChannel.Targets.SCALE,
                    new Keyframe(0.0F, KeyframeAnimations.scaleVec(0.6F, 0.6F, 0.6F), AnimationChannel.Interpolations.LINEAR)
            ))
            .build();
}