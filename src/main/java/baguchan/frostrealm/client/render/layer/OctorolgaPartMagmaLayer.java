...
public class OctorolgaPartMagmaLayer<T extends OctorolgaPart, M extends OctorolgaPartModel<T>> extends RenderLayer<T, M> {
	...
	public OctorolgaPartMagmaLayer(RenderLayerParent<T, M> p_116981_) {
		super(p_116981_);
	}
	...
	public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, T entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (!entitylivingbaseIn.isInvisible()) {
			...
			entitymodel.bone.visible = false;
		}
	}
