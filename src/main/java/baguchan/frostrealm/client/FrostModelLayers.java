...
public class FrostModelLayers {
    ...
    public static final ModelLayerLocation FROSTROM_DRAGON_PART = new ModelLayerLocation(new ResourceLocation(FrostRealm.MODID, "frostorm_dragon_part"), "frostorm_dragon_part");
