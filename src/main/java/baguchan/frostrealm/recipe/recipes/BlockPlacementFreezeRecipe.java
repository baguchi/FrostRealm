...
public class BlockPlacementFreezeRecipe extends AbstractPlacementFreezeRecipe<BlockState, BlockStateIngredient> {
	...
	public BlockPlacementFreezeRecipe(ResourceLocation id, @Nullable ResourceKey<Biome> biomeKey, @Nullable TagKey<Biome> biomeTag, BlockStateIngredient bypassBlock) {
		this(id, biomeKey, biomeTag, BlockPropertyPair.of(Blocks.AIR, Map.of()), bypassBlock, BlockStateIngredient.EMPTY);
	}
	...
	public static class Serializer extends PlacementFreezeRecipeSerializer<BlockState, BlockStateIngredient, BlockPlacementFreezeRecipe> {
		public Serializer() {
			super(BlockPlacementFreezeRecipe::new);
		}
		...
		public BlockPlacementFreezeRecipe fromJson(@Nonnull ResourceLocation recipeId, @Nonnull JsonObject serializedRecipe) {
			...
			BlockPropertyPair pair = BlockStateRecipeUtil.pairFromJson(serializedRecipe);
