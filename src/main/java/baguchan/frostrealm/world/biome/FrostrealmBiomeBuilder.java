...
public class FrostrealmBiomeBuilder {
	...
	private final ResourceKey<Biome>[][] MIDDLE_BIOMES = new ResourceKey[][]{{FrostBiomes.TUNDRA, FrostBiomes.TUNDRA, FrostBiomes.TUNDRA, FrostBiomes.FRIGID_FOREST, FrostBiomes.FRIGID_FOREST}, {FrostBiomes.TUNDRA, FrostBiomes.TUNDRA, FrostBiomes.FRIGID_FOREST, FrostBiomes.FRIGID_FOREST, FrostBiomes.FRIGID_FOREST}, {FrostBiomes.FRIGID_FOREST, FrostBiomes.TUNDRA, FrostBiomes.FRIGID_FOREST, FrostBiomes.FRIGID_FOREST, FrostBiomes.FRIGID_FOREST}, {FrostBiomes.TUNDRA, FrostBiomes.TUNDRA, FrostBiomes.FROZEN_JUNGLE, FrostBiomes.FROZEN_JUNGLE, FrostBiomes.FROZEN_JUNGLE}, {FrostBiomes.TUNDRA, FrostBiomes.TUNDRA, FrostBiomes.TUNDRA, FrostBiomes.TUNDRA, FrostBiomes.TUNDRA}};
	...
	private void addUndergroundBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> p_187227_) {
		...
		this.addUndergroundBiome(p_187227_, Climate.Parameter.span(-1.0F, 0.0F), Climate.Parameter.span(0.5F, 1.0F), this.FULL_RANGE, this.FULL_RANGE, this.FULL_RANGE, 0.0F, FrostBiomes.CRYSTAL_WATERFALL);
	}
