...
public class FrostrealmBiomeBuilder {
	...
	private final ResourceKey<Biome>[][] MIDDLE_BIOMES = new ResourceKey[][]{{FrostBiomes.DRIP_FOREST, FrostBiomes.DRIP_FOREST, FrostBiomes.DRIP_FOREST, FrostBiomes.FRIGID_FOREST, FrostBiomes.FRIGID_FOREST}, {FrostBiomes.DRIP_FOREST, FrostBiomes.DRIP_FOREST, FrostBiomes.FRIGID_FOREST, FrostBiomes.FRIGID_FOREST, FrostBiomes.FRIGID_FOREST}, {FrostBiomes.FRIGID_FOREST, FrostBiomes.TUNDRA, FrostBiomes.FRIGID_FOREST, FrostBiomes.FRIGID_FOREST, FrostBiomes.FRIGID_FOREST}, {FrostBiomes.FROSTBITE_FOREST, FrostBiomes.FROSTBITE_FOREST, FrostBiomes.FROSTBITE_FOREST, FrostBiomes.FROSTBITE_FOREST, FrostBiomes.FROSTBITE_FOREST}, {FrostBiomes.SHERBET_DESERT, FrostBiomes.SHERBET_DESERT, FrostBiomes.SHERBET_DESERT, FrostBiomes.SHERBET_DESERT, FrostBiomes.SHERBET_DESERT}};
	private final ResourceKey<Biome>[][] MIDDLE_BIOMES_VARIANT = new ResourceKey[][]{{null, null, null, FrostBiomes.DRIP_FOREST, FrostBiomes.DRIP_FOREST}, {null, null, null, null, null}, {null, null, null, null, null}, {null, null, null, null, null}, {null, null, null, null, null}};
	private final ResourceKey<Biome>[][] PLATEAU_BIOMES = new ResourceKey[][]{{FrostBiomes.STAR_DUST_PEAKS, FrostBiomes.STAR_DUST_PEAKS, FrostBiomes.TUNDRA, FrostBiomes.FRIGID_FOREST, FrostBiomes.FRIGID_FOREST}, {FrostBiomes.GLACIERS, FrostBiomes.GLACIERS, FrostBiomes.FRIGID_FOREST, FrostBiomes.FRIGID_FOREST, FrostBiomes.FRIGID_FOREST}, {FrostBiomes.GLACIERS, FrostBiomes.GLACIERS, FrostBiomes.GLACIERS, FrostBiomes.GLACIERS, FrostBiomes.HOT_ROCK}, {FrostBiomes.GLACIERS, FrostBiomes.GLACIERS, FrostBiomes.STAR_DUST_PEAKS, FrostBiomes.STAR_DUST_PEAKS, FrostBiomes.HOT_ROCK}, {FrostBiomes.GLACIERS, FrostBiomes.GLACIERS, FrostBiomes.GLACIERS, FrostBiomes.HOT_ROCK, FrostBiomes.HOT_ROCK}};
	private final ResourceKey<Biome>[][] PLATEAU_BIOMES_VARIANT = new ResourceKey[][]{{FrostBiomes.HOT_ROCK, FrostBiomes.HOT_ROCK, null, null, null}, {FrostBiomes.HOT_ROCK, FrostBiomes.HOT_ROCK, null, null, null}, {FrostBiomes.HOT_ROCK, FrostBiomes.HOT_ROCK, null, null, null}, {null, null, FrostBiomes.FRIGID_FOREST, FrostBiomes.FRIGID_FOREST, null}, {FrostBiomes.HOT_ROCK, FrostBiomes.HOT_ROCK, FrostBiomes.HOT_ROCK, null, null}};
	private final ResourceKey<Biome>[][] EXTREME_HILLS = new ResourceKey[][]{{FrostBiomes.WARPED_CLIFFS, FrostBiomes.WARPED_CLIFFS, FrostBiomes.FROZEN_CANYON, FrostBiomes.FRIGID_FOREST, FrostBiomes.FRIGID_FOREST}, {FrostBiomes.WARPED_CLIFFS, FrostBiomes.WARPED_CLIFFS, FrostBiomes.FROZEN_CANYON, FrostBiomes.FRIGID_FOREST, FrostBiomes.FRIGID_FOREST}, {FrostBiomes.FROZEN_CANYON, FrostBiomes.FROZEN_CANYON, FrostBiomes.FROZEN_CANYON, FrostBiomes.FRIGID_FOREST, FrostBiomes.FRIGID_FOREST}, {null, null, null, null, null}, {null, null, null, null, null}};
	...
	private void addMidSlice(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> p_187218_, Climate.Parameter p_187219_) {
		this.addSurfaceBiome(p_187218_, this.FULL_RANGE, this.FULL_RANGE, this.coastContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[2]), p_187219_, 0.0F, FrostBiomes.FROZEN_BEACH);
	...
	private void addLowSlice(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> p_187229_, Climate.Parameter p_187230_) {
		this.addSurfaceBiome(p_187229_, this.FULL_RANGE, this.FULL_RANGE, this.coastContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[2]), p_187230_, 0.0F, FrostBiomes.FROZEN_BEACH);
		//Replace swamp to something
	...
	private void addValleys(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> p_187238_, Climate.Parameter p_187239_) {
		this.addSurfaceBiome(p_187238_, this.FULL_RANGE, this.FULL_RANGE, this.coastContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[1]), p_187239_, 0.0F, p_187239_.max() < 0L ? FrostBiomes.FROZEN_BEACH : FrostBiomes.FROST_RIVER);
		this.addSurfaceBiome(p_187238_, this.FULL_RANGE, this.FULL_RANGE, this.nearInlandContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[1]), p_187239_, 0.0F, FrostBiomes.FROST_RIVER);

		this.addSurfaceBiome(p_187238_, this.FULL_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.coastContinentalness, this.farInlandContinentalness), Climate.Parameter.span(this.erosions[2], this.erosions[5]), p_187239_, 0.0F, FrostBiomes.FROST_RIVER);
		this.addSurfaceBiome(p_187238_, this.FULL_RANGE, this.FULL_RANGE, this.coastContinentalness, this.erosions[6], p_187239_, 0.0F, FrostBiomes.FROST_RIVER);
		...
		this.addSurfaceBiome(p_187238_, this.FULL_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.inlandContinentalness, this.farInlandContinentalness), this.erosions[6], p_187239_, 0.0F, FrostBiomes.FROST_RIVER);
	...
	private void addBottomBiome(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> p_220669_, Climate.Parameter p_220670_, Climate.Parameter p_220671_, Climate.Parameter p_220672_, Climate.Parameter p_220673_, Climate.Parameter p_220674_, float p_220675_, ResourceKey<Biome> p_220676_) {
		...
		p_220669_.accept(Pair.of(Climate.parameters(p_220670_, p_220671_, p_220672_, p_220673_, Climate.Parameter.point(0.8F), p_220674_, p_220675_), p_220676_));
	}
	...
	private ResourceKey<Biome> pickBeachBiome(int p_187161_, int p_187162_) {
		if (p_187161_ == 0) {
			return FrostBiomes.FROZEN_BEACH;
		} else {
			return FrostBiomes.FROZEN_BEACH;
		}
	}
