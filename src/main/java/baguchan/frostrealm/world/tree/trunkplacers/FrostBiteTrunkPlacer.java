package baguchan.frostrealm.world.tree.trunkplacers;

import baguchan.frostrealm.registry.FrostTrunkPlacers;
...
public class FrostBiteTrunkPlacer extends TrunkPlacer {
    ...
    public static final Codec<FrostBiteTrunkPlacer> CODEC = RecordCodecBuilder.create((p_273579_) -> {
        ...
        }))).apply(p_273579_, FrostBiteTrunkPlacer::new);
    });
    ...
    public FrostBiteTrunkPlacer(int p_273281_, int p_273327_, int p_272619_, IntProvider p_272873_, IntProvider p_272789_, UniformInt p_272917_, IntProvider p_272948_) {
    ...
    protected TrunkPlacerType<?> type() {
        return FrostTrunkPlacers.FROST_BITE_TRUNK_PLACER;
    }
    ...
    public List<FoliagePlacer.FoliageAttachment> placeTrunk(LevelSimulatedReader p_272827_, BiConsumer<BlockPos, BlockState> p_272650_, RandomSource p_272993_, int p_272990_, BlockPos p_273471_, TreeConfiguration p_273355_) {
        ...
        int length = this.branchHorizontalLength.sample(p_272993_);
