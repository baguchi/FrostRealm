...
public class FrozenTree extends AbstractMegaTreeGrower {
	@Nullable
	@Override
	protected Holder<? extends ConfiguredFeature<TreeConfiguration, ?>> getConfiguredFeature(RandomSource p_60014_, boolean p_60015_) {
		return FrostTreeFeatures.FROZEN_TREE;
	}

	protected Holder<? extends ConfiguredFeature<?, ?>> getConfiguredMegaFeature(RandomSource p_60032_) {
