...
public class FrostPlacements {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
		...
		PlacementUtils.register(context, DRIP_TREES, configuredFeature.getOrThrow(FrostTreeFeatures.DRIP_WOOD_TREE), treePlacement(PlacementUtils.countExtra(10, 0.1F, 1), FrostBlocks.DRIP_SAPLING.get()));
		...
		PlacementUtils.register(context, UNDERGRAUND_DELTA, configuredFeature.getOrThrow(FrostConfiguredFeatures.UNDERGROUND_DELTA), CountOnEveryLayerPlacement.of(8), BlockPredicateFilter.forPredicate(BlockPredicate.matchesBlocks(new Vec3i(0, 0, 0), FrostBlocks.PERMA_SLATE.get())), BiomeFilter.biome());
