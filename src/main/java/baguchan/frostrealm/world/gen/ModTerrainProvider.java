...
public class ModTerrainProvider {
    ...
    private static <C, I extends ToFloatFunction<C>> CubicSpline<C, I> getErosionFactor(I p_236623_, I p_236624_, I p_236625_, float p_236626_, boolean p_236627_, ToFloatFunction<Float> p_236628_) {
        ...
        if (p_236627_) {
            CubicSpline<C, I> cubicspline1 = CubicSpline.builder(p_236624_, p_236628_).addPoint(0.0F, p_236626_).addPoint(0.1F, 0.625F).build();
            CubicSpline<C, I> cubicspline2 = CubicSpline.builder(p_236625_, p_236628_).addPoint(-0.9F, p_236626_).addPoint(-0.69F, cubicspline1).build();
            builder.addPoint(0.35F, p_236626_).addPoint(0.45F, cubicspline2).addPoint(0.55F, cubicspline2).addPoint(0.62F, p_236626_);
        } else {
            CubicSpline<C, I> cubicspline3 = CubicSpline.builder(p_236625_, p_236628_).addPoint(-0.7F, cubicspline).addPoint(-0.15F, 1.37F).build();
            CubicSpline<C, I> cubicspline4 = CubicSpline.builder(p_236625_, p_236628_).addPoint(0.45F, cubicspline).addPoint(0.7F, 1.56F).build();
    ...
    static {
        ...
        AMPLIFIED_OFFSET = ToFloatFunction.createUnlimited((p_236651_) -> p_236651_ < 0.0F ? p_236651_ : p_236651_ * 2.0F);
        AMPLIFIED_FACTOR = ToFloatFunction.createUnlimited((p_236649_) -> 1.25F - 6.25F / (p_236649_ + 5.0F));
        AMPLIFIED_JAGGEDNESS = ToFloatFunction.createUnlimited((p_236641_) -> p_236641_ * 2.0F);
    }
}
