...
public class ModTerrainProvider {
    ...
    public static <C, I extends ToFloatFunction<C>> CubicSpline<C, I> overworldFactor(I toFloatFunction, I toFloatFunction2, I toFloatFunction3, I toFloatFunction4, boolean bl) {
        ...
        return CubicSpline.builder(toFloatFunction, NO_TRANSFORM).addPoint(-0.19f, 3.95f).addPoint(-0.15f, ModTerrainProvider.getErosionFactor(toFloatFunction2, toFloatFunction3, toFloatFunction4, 6.25f, true, NO_TRANSFORM)).addPoint(-0.1f, ModTerrainProvider.getErosionFactor(toFloatFunction2, toFloatFunction3, toFloatFunction4, 5.47f, true, toFloatFunction5)).addPoint(0.03f, ModTerrainProvider.getErosionFactor(toFloatFunction2, toFloatFunction3, toFloatFunction4, 5.08f, true, toFloatFunction5)).addPoint(0.06f, ModTerrainProvider.getErosionFactor(toFloatFunction2, toFloatFunction3, toFloatFunction4, 4.69f, false, toFloatFunction5)).build();
    }
    ...
    private static <C, I extends ToFloatFunction<C>> CubicSpline<C, I> buildErosionJaggednessSpline(I toFloatFunction, I toFloatFunction2, I toFloatFunction3, float f, float g, float h, float i, ToFloatFunction<Float> toFloatFunction4) {
        float j = -0.5775f;
        CubicSpline<C, I> cubicSpline = ModTerrainProvider.buildRidgeJaggednessSpline(toFloatFunction2, toFloatFunction3, f, h, toFloatFunction4);
        CubicSpline<C, I> cubicSpline2 = ModTerrainProvider.buildRidgeJaggednessSpline(toFloatFunction2, toFloatFunction3, g, i, toFloatFunction4);
    ...
    private static <C, I extends ToFloatFunction<C>> CubicSpline<C, I> buildRidgeJaggednessSpline(I toFloatFunction, I toFloatFunction2, float f, float g, ToFloatFunction<Float> toFloatFunction3) {
        ...
        if (g > 0.0f) {
            builder.addPoint(j, ModTerrainProvider.buildWeirdnessJaggednessSpline(toFloatFunction, g, toFloatFunction3));
        } else {
            builder.addPoint(j, 0.0f);
        }
        if (f > 0.0f) {
            builder.addPoint(1.0f, ModTerrainProvider.buildWeirdnessJaggednessSpline(toFloatFunction, f, toFloatFunction3));
        } else {
    ...
    private static <C, I extends ToFloatFunction<C>> CubicSpline<C, I> buildMountainRidgeSplineWithPoints(I toFloatFunction, float f, boolean bl, ToFloatFunction<Float> toFloatFunction2) {
        ...
        float g = -0.7f;
        float h = -1.0f;
        float i = ModTerrainProvider.mountainContinentalness(-1.0f, f, -0.7f);
        float j = 1.0f;
        float k = ModTerrainProvider.mountainContinentalness(1.0f, f, -0.7f);
        float l = ModTerrainProvider.calculateMountainRidgeZeroContinentalnessPoint(f);
        float m = -0.65f;
        if (-0.65f < l && l < 1.0f) {
            float n = ModTerrainProvider.mountainContinentalness(-0.65f, f, -0.7f);
            float o = -0.75f;
            float p = ModTerrainProvider.mountainContinentalness(-0.75f, f, -0.7f);
            float q = ModTerrainProvider.calculateSlope(i, p, -1.0f, -0.75f);
            builder.addPoint(-1.0f, i, q);
            builder.addPoint(-0.75f, p);
            builder.addPoint(-0.65f, n);
            float r = ModTerrainProvider.mountainContinentalness(l, f, -0.7f);
            float s = ModTerrainProvider.calculateSlope(r, k, l, 1.0f);
            float t = 0.01f;
            builder.addPoint(l - 0.01f, r);
            builder.addPoint(l, r, s);
            builder.addPoint(1.0f, k, s);
        } else {
            float n = ModTerrainProvider.calculateSlope(i, k, -1.0f, 1.0f);
            if (bl) {
    ...
    public static <C, I extends ToFloatFunction<C>> CubicSpline<C, I> buildErosionOffsetSpline(I toFloatFunction, I toFloatFunction2, float f, float g, float h, float i, float j, float k, boolean bl, boolean bl2, ToFloatFunction<Float> toFloatFunction3) {
        ...
        float m = 0.5f;
        float n = 0.5f;
        CubicSpline<C, I> cubicSpline = ModTerrainProvider.buildMountainRidgeSplineWithPoints(toFloatFunction2, Mth.lerp(i, 0.6f, 1.5f), bl2, toFloatFunction3);
        CubicSpline<C, I> cubicSpline2 = ModTerrainProvider.buildMountainRidgeSplineWithPoints(toFloatFunction2, Mth.lerp(i, 0.6f, 1.0f), bl2, toFloatFunction3);
        CubicSpline<C, I> cubicSpline3 = ModTerrainProvider.buildMountainRidgeSplineWithPoints(toFloatFunction2, i, bl2, toFloatFunction3);


        CubicSpline<C, I> cubicSpline4 = ModTerrainProvider.ridgeSpline(toFloatFunction2, f - 0.15f, 0.5f * i, Mth.lerp(0.5f, 0.5f, 0.5f) * i, 0.5f * i, 0.6f * i, 0.5f, toFloatFunction3);
        CubicSpline<C, I> cubicSpline5 = ModTerrainProvider.ridgeSpline(toFloatFunction2, f, j * i, g * i, 0.5f * i, 0.6f * i, 0.5f, toFloatFunction3);
        CubicSpline<C, I> cubicSpline6 = ModTerrainProvider.ridgeSpline(toFloatFunction2, f, j, j, g, h, 0.5f, toFloatFunction3);
        CubicSpline<C, I> cubicSpline7 = ModTerrainProvider.ridgeSpline(toFloatFunction2, f, j, j, g, h, 0.5f, toFloatFunction3);
        ...
        CubicSpline<C, I> cubicSpline9 = ModTerrainProvider.ridgeSpline(toFloatFunction2, -0.02f, k, k, g, h, 0.0f, toFloatFunction3);
