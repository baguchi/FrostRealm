...
public class FrostStructureSettings extends StructureSettings {
	...
	public FrostStructureSettings(Optional<StrongholdConfiguration> empty, Map<StructureFeature<?>, StructureFeatureConfiguration> map) {
		super(empty, map);
