...
public class FrostTerrainProvider {
	private static final ToFloatFunction<Float> NO_TRANSFORM = (p_187318_) -> {
		return p_187318_;
	};

	private static float getAmplifiedOffset(float p_187325_) {
		return p_187325_ < 0.0F ? p_187325_ : p_187325_ * 1.5F;
	}

	private static float getAmplifiedFactor(float p_187338_) {
		return p_187338_ * 1.5F;
	}

	private static float getAmplifiedJaggedness(float p_187342_) {
		return p_187342_ * 1.5F;
	}

	public static TerrainShaper frostrealm(boolean p_187322_) {
		ToFloatFunction<Float> tofloatfunction = p_187322_ ? FrostTerrainProvider::getAmplifiedOffset : NO_TRANSFORM;
		ToFloatFunction<Float> tofloatfunction1 = p_187322_ ? FrostTerrainProvider::getAmplifiedFactor : NO_TRANSFORM;
		ToFloatFunction<Float> tofloatfunction2 = p_187322_ ? FrostTerrainProvider::getAmplifiedJaggedness : NO_TRANSFORM;
		...
		float f2 = 0.1F;
		float f3 = -0.15F;
		CubicSpline<TerrainShaper.Point> cubicspline4 = CubicSpline.builder(FrostTerrainProvider.Coordinate.CONTINENTS, tofloatfunction).addPoint(-1.1F, 0.044F, 0.0F).addPoint(-1.02F, -0.2222F, 0.0F).addPoint(-0.51F, -0.2222F, 0.0F).addPoint(-0.44F, -0.12F, 0.0F).addPoint(-0.18F, -0.12F, 0.0F).addPoint(-0.16F, cubicspline, 0.0F).addPoint(-0.15F, cubicspline, 0.0F).addPoint(-0.1F, cubicspline1, 0.0F).addPoint(0.25F, cubicspline2, 0.0F).addPoint(1.0F, cubicspline3, 0.0F).build();
		CubicSpline<TerrainShaper.Point> cubicspline5 = CubicSpline.builder(FrostTerrainProvider.Coordinate.CONTINENTS, NO_TRANSFORM).addPoint(-0.19F, 3.95F, 0.0F).addPoint(-0.15F, getErosionFactor(6.25F, true, NO_TRANSFORM), 0.0F).addPoint(-0.1F, getErosionFactor(5.47F, true, tofloatfunction1), 0.0F).addPoint(0.03F, getErosionFactor(5.08F, true, tofloatfunction1), 0.0F).addPoint(0.06F, getErosionFactor(4.69F, false, tofloatfunction1), 0.0F).addPoint(0.25F, getErosionFactor(3.2F, false, tofloatfunction1), 0.0F).addPoint(0.4F, getErosionFactor(3.2F, false, tofloatfunction1), 0.0F).addPoint(0.8F, getErosionFactor(6.5F, false, tofloatfunction1), 0.0F).build();
		float f4 = 0.65F;
		CubicSpline<TerrainShaper.Point> cubicspline6 = CubicSpline.builder(FrostTerrainProvider.Coordinate.CONTINENTS, tofloatfunction2).addPoint(-0.11F, 0.0F, 0.0F).addPoint(0.03F, buildErosionJaggednessSpline(1.0F, 0.5F, 0.0F, 0.0F, tofloatfunction2), 0.0F).addPoint(0.65F, buildErosionJaggednessSpline(1.0F, 1.0F, 1.0F, 0.0F, tofloatfunction2), 0.0F).build();
	...
	private static CubicSpline<TerrainShaper.Point> buildErosionJaggednessSpline(float p_187295_, float p_187296_, float p_187297_, float p_187298_, ToFloatFunction<Float> p_187299_) {
		...
		return CubicSpline.builder(FrostTerrainProvider.Coordinate.EROSION, p_187299_).addPoint(-1.0F, cubicspline, 0.0F).addPoint(-0.78F, cubicspline1, 0.0F).addPoint(-0.5775F, cubicspline1, 0.0F).addPoint(-0.375F, 0.0F, 0.0F).build();
	}
	...
	private static CubicSpline<TerrainShaper.Point> buildRidgeJaggednessSpline(float p_187301_, float p_187302_, ToFloatFunction<Float> p_187303_) {
		...
		float f2 = (f + f1) / 2.0F;
		CubicSpline.Builder<TerrainShaper.Point> builder = CubicSpline.builder(FrostTerrainProvider.Coordinate.RIDGES, p_187303_);
	...
	private static CubicSpline<TerrainShaper.Point> buildWeirdnessJaggednessSpline(float p_187305_, ToFloatFunction<Float> p_187306_) {
		...
		return CubicSpline.builder(FrostTerrainProvider.Coordinate.WEIRDNESS, p_187306_).addPoint(-0.01F, f, 0.0F).addPoint(0.01F, f1, 0.0F).build();
	}
	...
	private static CubicSpline<TerrainShaper.Point> getErosionFactor(float p_187308_, boolean p_187309_, ToFloatFunction<Float> p_187310_) {
		CubicSpline<TerrainShaper.Point> cubicspline = CubicSpline.builder(FrostTerrainProvider.Coordinate.WEIRDNESS, p_187310_).addPoint(-0.2F, 6.3F, 0.0F).addPoint(0.2F, p_187308_, 0.0F).build();
		CubicSpline.Builder<TerrainShaper.Point> builder = CubicSpline.builder(FrostTerrainProvider.Coordinate.EROSION, p_187310_).addPoint(-0.6F, cubicspline, 0.0F).addPoint(-0.5F, CubicSpline.builder(FrostTerrainProvider.Coordinate.WEIRDNESS, p_187310_).addPoint(-0.05F, 6.3F, 0.0F).addPoint(0.05F, 2.67F, 0.0F).build(), 0.0F).addPoint(-0.35F, cubicspline, 0.0F).addPoint(-0.25F, cubicspline, 0.0F).addPoint(-0.1F, CubicSpline.builder(FrostTerrainProvider.Coordinate.WEIRDNESS, p_187310_).addPoint(-0.05F, 2.67F, 0.0F).addPoint(0.05F, 6.3F, 0.0F).build(), 0.0F).addPoint(0.03F, cubicspline, 0.0F);
		if (p_187309_) {
			CubicSpline<TerrainShaper.Point> cubicspline1 = CubicSpline.builder(FrostTerrainProvider.Coordinate.WEIRDNESS, p_187310_).addPoint(0.0F, p_187308_, 0.0F).addPoint(0.1F, 0.625F, 0.0F).build();
			CubicSpline<TerrainShaper.Point> cubicspline2 = CubicSpline.builder(FrostTerrainProvider.Coordinate.RIDGES, p_187310_).addPoint(-0.9F, p_187308_, 0.0F).addPoint(-0.69F, cubicspline1, 0.0F).build();
			...
			CubicSpline<TerrainShaper.Point> cubicspline3 = CubicSpline.builder(FrostTerrainProvider.Coordinate.RIDGES, p_187310_).addPoint(-0.7F, cubicspline, 0.0F).addPoint(-0.15F, 1.37F, 0.0F).build();
			CubicSpline<TerrainShaper.Point> cubicspline4 = CubicSpline.builder(FrostTerrainProvider.Coordinate.RIDGES, p_187310_).addPoint(0.45F, cubicspline, 0.0F).addPoint(0.7F, 1.56F, 0.0F).build();
	...
	private static CubicSpline<TerrainShaper.Point> buildMountainRidgeSplineWithPoints(float p_187331_, boolean p_187332_, ToFloatFunction<Float> p_187333_) {
		CubicSpline.Builder<TerrainShaper.Point> builder = CubicSpline.builder(FrostTerrainProvider.Coordinate.RIDGES, p_187333_);
		float f = -0.7F;
		float f1 = -1.0F;
	...
	private static CubicSpline<TerrainShaper.Point> buildErosionOffsetSpline(float p_187285_, float p_187286_, float p_187287_, float p_187288_, float p_187289_, float p_187290_, boolean p_187291_, boolean p_187292_, ToFloatFunction<Float> p_187293_) {
		...
		CubicSpline<TerrainShaper.Point> cubicspline7 = CubicSpline.builder(FrostTerrainProvider.Coordinate.RIDGES, p_187293_).addPoint(-1.0F, p_187285_, 0.0F).addPoint(-0.4F, cubicspline5, 0.0F).addPoint(0.0F, p_187287_ + 0.07F, 0.0F).build();
		CubicSpline<TerrainShaper.Point> cubicspline8 = ridgeSpline(-0.02F, p_187290_, p_187290_, p_187286_, p_187287_, 0.0F, p_187293_);
		CubicSpline.Builder<TerrainShaper.Point> builder = CubicSpline.builder(FrostTerrainProvider.Coordinate.EROSION, p_187293_).addPoint(-0.85F, cubicspline, 0.0F).addPoint(-0.7F, cubicspline1, 0.0F).addPoint(-0.4F, cubicspline2, 0.0F).addPoint(-0.35F, cubicspline3, 0.0F).addPoint(-0.1F, cubicspline4, 0.0F).addPoint(0.2F, cubicspline5, 0.0F);
		if (p_187291_) {
	...
	private static CubicSpline<TerrainShaper.Point> ridgeSpline(float p_187277_, float p_187278_, float p_187279_, float p_187280_, float p_187281_, float p_187282_, ToFloatFunction<Float> p_187283_) {
		...
		return CubicSpline.builder(FrostTerrainProvider.Coordinate.RIDGES, p_187283_).addPoint(-1.0F, p_187277_, f).addPoint(-0.4F, p_187278_, Math.min(f, f1)).addPoint(0.0F, p_187279_, f1).addPoint(0.4F, p_187280_, 2.0F * (p_187280_ - p_187279_)).addPoint(1.0F, p_187281_, 0.7F * (p_187281_ - p_187280_)).build();
	}
	...
	protected enum Coordinate implements StringRepresentable, ToFloatFunction<TerrainShaper.Point> {
		...
		private static final Map<String, Coordinate> BY_NAME = Arrays.stream(values()).collect(Collectors.toMap(FrostTerrainProvider.Coordinate::getSerializedName, (p_187371_) -> {
			return p_187371_;
		}));
		private static final Codec<FrostTerrainProvider.Coordinate> CODEC = StringRepresentable.fromEnum(FrostTerrainProvider.Coordinate::values, BY_NAME::get);
		static final Codec<ToFloatFunction<TerrainShaper.Point>> WIDE_CODEC = CODEC.flatComapMap((p_187365_) -> {
			return p_187365_;
		}, (p_187363_) -> {
			DataResult dataresult;
			if (p_187363_ instanceof FrostTerrainProvider.Coordinate) {
				FrostTerrainProvider.Coordinate terrainshaper$coordinate = (FrostTerrainProvider.Coordinate) p_187363_;
