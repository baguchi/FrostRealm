...
public class SledgeItem extends Item {
    ...
    private final Sledge.Type type;
    private final boolean hasChest;

    public SledgeItem(boolean p_220013_, Sledge.Type p_220014_, Item.Properties p_220015_) {
        super(p_220015_);
    ...
    public InteractionResultHolder<ItemStack> use(Level p_40622_, Player p_40623_, InteractionHand p_40624_) {
        ...
        if (hitresult.getType() == HitResult.Type.MISS) {
            ...
            if (hitresult.getType() == HitResult.Type.BLOCK) {
                Boat boat = this.getSledge(p_40622_, hitresult);
    ...
    private Boat getSledge(Level p_220017_, HitResult p_220018_) {
        return (Boat) (this.hasChest ? new ChestSledge(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z) : new Sledge(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z));
    }
}