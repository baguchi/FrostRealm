...
public class FrostCarvers {
	...
	public static void registerConfigurations(Registry<ConfiguredWorldCarver<?>> registry) {
		Registry.register(registry, FrostRealm.prefix("frostrealm_cave"), CAVE);
		Registry.register(registry, FrostRealm.prefix("frostrealm_cave_extra_underground"), CAVE_UNDERGROUND);
		Registry.register(registry, FrostRealm.prefix("frostrealm_canyon"), CANYON);
	}
}
