...
public class FrostEffects {
	...
	public static final Holder<MobEffect> COLD_SENSITIVITY = MOB_EFFECTS.register("cold_sensitivity", () -> new ColdSensitivityEffect(MobEffectCategory.HARMFUL, 0x545A95));
