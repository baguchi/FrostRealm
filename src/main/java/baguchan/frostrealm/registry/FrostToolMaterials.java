...
public class FrostToolMaterials {
    ...
    public static final ToolMaterial FROST_SPEAR = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 1040, 7.5F, 3.0F, 25, FrostTags.Items.RARE_TOOL_MATERIAL);
    public static final ToolMaterial GLACINIUM = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 2531, 9.5F, 4.5F, 18, FrostTags.Items.GLACINIUM_TOOL_MATERIAL);
}