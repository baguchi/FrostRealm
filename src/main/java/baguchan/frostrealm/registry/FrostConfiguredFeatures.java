...
public class FrostConfiguredFeatures {
	...
	public static final ConfiguredFeature<?, ?> FROST_CRYSTAL_EXTRA = register(prefix("frost_crystal_ore_extra"), Feature.ORE.configured(new OreConfiguration(ORE_FROST_CRYSTAL_TARGET_LIST, 12, 0.7F)).rangeTriangle(VerticalAnchor.absolute(32), VerticalAnchor.absolute(320)).squared().count(5));
