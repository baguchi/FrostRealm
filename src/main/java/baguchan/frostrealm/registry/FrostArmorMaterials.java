...
public class FrostArmorMaterials {
	...
	public static final ArmorMaterial GLACIER_BOAR_FUR = new ArmorMaterial(15, Util.make(new EnumMap<>(ArmorType.class), (p_266652_) -> {
		p_266652_.put(ArmorType.BOOTS, 2);
		p_266652_.put(ArmorType.LEGGINGS, 5);
		p_266652_.put(ArmorType.CHESTPLATE, 6);
		p_266652_.put(ArmorType.HELMET, 2);
		p_266652_.put(ArmorType.BODY, 10);
	}), 15, SoundEvents.ARMOR_EQUIP_LEATHER, 1.5F, 0.0F, FrostTags.Items.BOAR_FUR_MATERIAL, FrostEquipmentAssets.GLACIER_BOAR_FUR);
