...
public class FrostArmorMaterials {
	...
	}), 15, SoundEvents.ARMOR_EQUIP_LEATHER, 1.0F, 0.0F, FrostTags.Items.YETI_FUR_MATERIAL, FrostEquipmentModels.YETI_FUR);
	public static final ArmorMaterial FROST_BOAR_FUR = new ArmorMaterial(15, Util.make(new EnumMap<>(ArmorType.class), (p_266652_) -> {
		...
		p_266652_.put(ArmorType.HELMET, 2);
		p_266652_.put(ArmorType.BODY, 5);
	}), 15, SoundEvents.ARMOR_EQUIP_LEATHER, 1.0F, 0.0F, FrostTags.Items.BOAR_FUR_MATERIAL, FrostEquipmentModels.FROST_BOAR_FUR);
	...
	}), 12, SoundEvents.ARMOR_EQUIP_IRON, 1.5F, 0.0F, FrostTags.Items.ASTRIUM_TOOL_MATERIAL, FrostEquipmentModels.ASTRIUM);
