...
public class FrostEntities {
    ...
    public static final Supplier<EntityType<Venochem>> VENOCHEM = ENTITIES.register("venochem", () -> EntityType.Builder.of(Venochem::new, MobCategory.MONSTER).sized(0.95F, 0.95F).eyeHeight(0.45F).fireImmune().build(prefix("venochem")));
