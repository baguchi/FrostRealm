...
public class FrostEntities {
    ...
    public static final Supplier<EntityType<CorruptedWalker>> CORRUPTED_WALKER = ENTITIES.register("corruped_walker", () -> EntityType.Builder.of(CorruptedWalker::new, MobCategory.CREATURE).sized(2.0F, 1.0F).eyeHeight(0.8F).build(prefix("corruped_walker")));
