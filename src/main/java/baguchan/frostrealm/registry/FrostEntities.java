...
public class FrostEntities {
    ...
    public static final Supplier<EntityType<SilkMoonWorm>> SILK_MOON_WORM = ENTITIES.register("silk_moon_worm", () -> EntityType.Builder.of(SilkMoonWorm::new, MobCategory.CREATURE).sized(0.5F, 0.3F).eyeHeight(0.15F).clientTrackingRange(10).build(prefix("silk_moon_worm")));
    public static final Supplier<EntityType<SilkMoon>> SILK_MOON = ENTITIES.register("silk_moon", () -> EntityType.Builder.of(SilkMoon::new, MobCategory.CREATURE).sized(0.5F, 0.5F).eyeHeight(0.35F).clientTrackingRange(10).build(prefix("silk_moon")));
    ...
    public static final Supplier<EntityType<LesserWarrior>> LESSER_WARRIOR = ENTITIES.register("lesser_warrior", () -> EntityType.Builder.of(LesserWarrior::new, MobCategory.MONSTER).sized(0.6F, 1.99F).immuneTo(Blocks.POWDER_SNOW).clientTrackingRange(8).build(prefix("lesser_warrior")));
    ...
    public static final Supplier<EntityType<Venochem>> VENOCHEM = ENTITIES.register("venochem", () -> EntityType.Builder.of(Venochem::new, MobCategory.MONSTER).sized(0.8F, 0.8F).eyeHeight(0.45F).build(prefix("venochem")));
    ...
    public static final Supplier<EntityType<FrostCrawler>> FROST_CRAWLER = ENTITIES.register("frost_crawler", () -> EntityType.Builder.of(FrostCrawler::new, MobCategory.MONSTER).sized(0.8F, 2.95F).eyeHeight(2.9F).build(prefix("frost_crawler")));
