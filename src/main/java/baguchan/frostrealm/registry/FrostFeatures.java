...
public class FrostFeatures {
    ...
    public static final Supplier<Feature<HeightBlockStateConfiguration>> SHAPE_CRYSTAL = FEATURES.register("shape_crystal", () -> new ShapeCrystalFeature(HeightBlockStateConfiguration.CODEC));
    public static final Supplier<Feature<HeightBlockStateConfiguration>> SMALL_VOLCANO = FEATURES.register("small_volcano", () -> new SmallVolcanoFeature(HeightBlockStateConfiguration.CODEC));
