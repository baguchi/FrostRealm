...
import static baguchan.frostrealm.entity.WarpedInsect.TICKS_PER_FLAP;

public class WarpedInsectPart extends LivingEntity implements IHurtableMultipart {
    private static final EntityDataAccessor<Integer> BODYINDEX = SynchedEntityData.defineId(WarpedInsectPart.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Optional<UUID>> PARENT_UUID = SynchedEntityData.defineId(WarpedInsectPart.class, EntityDataSerializers.OPTIONAL_UUID);
    ...
    public WarpedInsectPart(EntityType t, Level world) {
        super(t, world);
        multipartSize = t.getDimensions();
    }

    public WarpedInsectPart(EntityType t, LivingEntity parent, float radius, float angleYaw, float offsetY) {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Monster.createMonsterAttributes().add(Attributes.MAX_HEALTH, 14.0D).add(Attributes.ATTACK_DAMAGE, 3.0D);
    }
