...
public class ClustWraith extends FrostWraith implements RangedAttackMob {
	...
	public void performRangedAttack(LivingEntity p_29912_, float p_29913_) {
		...
		for (int i = 0; i < 3; i++) {
			...
			crystal.shoot(d1 + f * (this.random.nextDouble() - this.random.nextDouble()), d2 + f * (this.random.nextDouble() - this.random.nextDouble()), d3 + f * (this.random.nextDouble() - this.random.nextDouble()), 0.8F, 0.2F);
