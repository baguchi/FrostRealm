...
public class SnowMoveControl extends MoveControl {
	private final int maxTurnX;
	private final int maxTurnY;
	private final float inSnowSpeedModifier;

	public SnowMoveControl(Mob p_148070_, int p_148071_, int p_148072_, float p_148073_) {
		super(p_148070_);
		this.maxTurnX = p_148071_;
		this.maxTurnY = p_148072_;
		this.inSnowSpeedModifier = p_148073_;
	}
