...
public class MeleeAttackNonFlyingGoal<T extends PathfinderMob & IFlyMob> extends MeleeAttackGoal {
    protected final T flyMob;

    public MeleeAttackNonFlyingGoal(T flyMob, double p_25754_, boolean p_25755_) {
