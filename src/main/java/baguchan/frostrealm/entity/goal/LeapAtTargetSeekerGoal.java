...
public class LeapAtTargetSeekerGoal extends Goal {
    private static final ObjectArrayList<Integer> ALLOWED_ANGLES = new ObjectArrayList<>(Lists.newArrayList(45, 50, 55, 60));
    ...
    public LeapAtTargetSeekerGoal(Mob p_25492_, float maxJumpVelocityMultiplier) {
        this.mob = p_25492_;
    ...
    @Override
    public void start() {
        this.jumpCooldown = 80 + this.mob.getRandom().nextInt(100);
    ...
    public void jumpStart(Mob mob) {
        ...
        if (mob instanceof Seeker seeker) {
            seeker.setState(Seeker.SeekerState.JUMP);
        }
    }
    ...
    public void jumpStop(Mob mob) {
        ...
        if (mob instanceof Seeker seeker) {
            seeker.setState(Seeker.SeekerState.JUMP_STOP);
        }
    }
