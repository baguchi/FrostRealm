...
public class LeapAtTargetWolfflueGoal extends Goal {
    private static final ObjectArrayList<Integer> ALLOWED_ANGLES = new ObjectArrayList<>(Lists.newArrayList(40, 45, 50, 55));
    ...
    public LeapAtTargetWolfflueGoal(Mob p_25492_, float maxJumpVelocityMultiplier) {
        this.mob = p_25492_;
    ...
    @Override
    public void start() {
        this.jumpCooldown = 20 + this.mob.getRandom().nextInt(40);
