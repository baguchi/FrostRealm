...
public class Venochem extends Monster implements RangedAttackMob {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(5, new ShootProjectileAnimationGoal(this, 0.8F, 20 * 4, 20 * 8, 10.0F));
    ...
    public void performRangedAttack(LivingEntity target, float distanceFactor) {
        VenomBall dart = new VenomBall(FrostEntities.VENOM_BALL.get(), this, this.level());
